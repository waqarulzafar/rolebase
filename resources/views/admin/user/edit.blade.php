            ...
            <div class="container">
                ...
                <div class="card card-custom">
                    <div class="card-body">
                        ...
                        <div class="container">
                            <h3 align="center">Edi User</h3>

                            <form class="form" id="kt_form_1" enctype="multipart/form-data" method="post"  action="{{ url('admin/user/postedituser/'.$user->id) }}">
                                {{ csrf_field() }}
                                <div class="card-body">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <input value="{{ $user->phone }}" type="text" name="phone" class="form-control" placeholder="Enter contact number"/>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-6">
                                            ...
                                            <div class="input-group">
                                                <input value="{{ $user->email }}" name="email" type="text" class="form-control" placeholder="Enter your email"/>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-6">
                                            <label>Address:</label>
                                            <div class="input-group">
                                                <input value="{{ $user->address }}" name="address" type="text" class="form-control" placeholder="Enter your address"/>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-12 text-center">
                                            <div class="image-input image-input-empty image-input-outline" id="kt_image_5" style="background-image: url('{{ url('uploads/'.$user->picture) }}')">
...
@section('js')
    <script src="{{ asset('adminside/user/newuser.js') }}"></script>
    <script>
