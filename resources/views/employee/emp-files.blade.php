        ...
        <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-2">
                    <!--begin::Title-->
                    <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Files</h5>
                    <!--end::Title-->
                    <!--begin::Separator-->
                    ...
                    <div class="d-flex align-items-center" id="kt_subheader_search">
                        <span class="text-dark-50 font-weight-bold" id="kt_subheader_total">{{$files->total()}} Total</span>
                        <form class="ml-5">
                            <div class="input-group input-group-sm input-group-solid" style="max-width: 175px">
                                <input type="text" name="q" class="form-control" id="kt_subheader_search_form"
                                       placeholder="Search...">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <!--end::Button-->
                    <!--begin::Button-->
{{--                    <a href="/metronic/demo1/custom/apps/projects/add-project.html"--}}
{{--                       class="btn btn-light-primary font-weight-bold ml-2">Add File</a>--}}
                    <!--end::Button-->
                    <!--begin::Dropdown-->
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-4 col-sm-4">
                        ...
                        <div class="card card-custom gutter-b card-stretch">
                            ...
                            <div class="card-body text-center pt-4">
                                ...
                                <!--begin::Name-->
                                <div class="my-4">
                                    <a href="#" class="text-dark font-weight-bold text-hover-primary font-size-h4">{{$file->name}} </a>
                                </div>
                                <div class="mt-9">
